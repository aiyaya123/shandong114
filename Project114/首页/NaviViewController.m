...
//  Project114
//
//  Created by fosung_002 on 16/8/12.
...
- (void)startNavi
{
    ...
    if (useMyLocation) {
        ...
        startNode.pos.eType = BNCoordinate_OriginalGPS;
                ...
                startNode.pos.y = 29.549555;
                startNode.pos.eType = BNCoordinate_BaiduMapSDK;
//        startNode.address=@"北京水立方";
    }
    ...
    BNRoutePlanNode *endNode = [[BNRoutePlanNode alloc] init];
        ...
        endNode.pos.x = 113.089863;
        endNode.pos.y = 29.546236;
        endNode.pos.eType = BNCoordinate_BaiduMapSDK;
//    endNode.address=@"北京大学";
