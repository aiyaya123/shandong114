...
-(UIView *)blackView
{
    if(!_blackView)
    {
        _blackView = [[UIView alloc] initWithFrame:CGRectMake(0, 64, kScreenW, kScreenH-64)];
...
-(ResultCityController *)resultController
{
    if(!_resultController)
    {
        ...
        _resultController.view.frame = CGRectMake(0, 64, kScreenW, kScreenH-64);
...
- (void)viewDidLoad {
    ...
    self.searchView = [[CustomSearchView alloc] initWithFrame:CGRectMake(0, 0, kScreenW-20, 44)];
    ...
    self.navView = [[CustomTopView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 64)];
...
-(void)searchBeginEditing
{
    ...
    [UIView animateWithDuration:0.15 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        ...
        self.navView.frame = CGRectMake(0, -64, kScreenW, 64);
        _tableView.frame = CGRectMake(0, 20, kScreenW, kScreenH);
        self.blackView.alpha = 0.6;
        
    } completion:^(BOOL finished) {
        UIView *view1 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 20)];
        view1.tag = 333;
...
-(void)didSelectCancelBtn
{
    ...
    [UIView animateWithDuration:0.15 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        ...
        self.navView.frame = CGRectMake(0, 0, kScreenW, 64);
...
//    [self.dataArray insertObject:self.hotCityArray atIndex:0];
    ...
    NSLog(@"%ld",self.sectionTitlesArray.count);
    NSLog(@"%@",self.sectionTitlesArray);
}
